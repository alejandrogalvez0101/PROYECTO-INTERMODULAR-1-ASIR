...
El objetivo principal es demostrar la capacidad de integrar diferentes áreas de la informática (ASIR) para resolver un caso de negocio real, garantizando la seguridad, escalabilidad e interoperabilidad de los datos.
...
* **Contenido:** Diseño lógico y físico de la infraestructura de red.
* **Hitos:** * Direccionamiento IP (IPv4) y segmentación de red.
    * Diseño de cableado estructurado.
    * Configuración de seguridad perimetral básica.
* **Enfoque:** Garantizar una conectividad fluida y segura entre aulas y servidores.
### 2. Hardware del Sistema
* **Contenido:** Análisis y selección de los componentes físicos necesarios para la academia.
* **Hitos:** * Dimensionamiento del servidor principal (CPU, RAM, Almacenamiento).
...
* **Hitos:**
    * Gestión de usuarios y grupos (Active Directory / Local).
...
##  Autor
**Alejandro Galvez Cordero** - Estudiante de Administración de Sistemas Informáticos en Red (ASIR).

---

## Conclusión
Este repositorio no solo contiene código y configuraciones, sino una **estrategia tecnológica completa**. La integración de estos módulos permite que **IT Alex Academy** opere de manera eficiente en un entorno de producción real, protegiendo su activo más valioso: la información.
